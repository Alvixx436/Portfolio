...
export const images: Project[] = [
  {
    ...
    techStack: [
      { name: "ASP.NET (MVC)", logo: "dotnet", color: "text-purple-500" },
      { name: "Bootstrap", logo: "bootstrap", color: "text-purple-600" },
      { name: "SQL Server", logo: "mysql", color: "text-blue-600" },
    ],
  },

  {
    ...
    techStack: [
      { name: "React", logo: "react", color: "text-sky-500" },
      { name: "Laravel", logo: "laravel", color: "text-red-500" },
      { name: "SQL Server", logo: "mysql", color: "text-blue-600" },
      { name: "Tailwind", logo: "tailwind", color: "text-cyan-400" },
      { name: "Filament", logo: "laravel", color: "text-pink-500" },
    ],
  },
  {
    ID: 3,
  ...
  },
  {
    ...
    techStack: [
      { name: "C# WinForms", logo: "csharp", color: "text-purple-600" },
      { name: "SQL Server", logo: "mysql", color: "text-blue-600" },
    ],
  },
